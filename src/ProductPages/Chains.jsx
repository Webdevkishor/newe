...
<br></br>
            ...
            <div className="">
            <div className="grid grid-cols-12 sm:gap-6 gap-4 p-2 sm:px-16">
                <div className="sm:col-span-3 col-span-6 relative">
                    <img src="https://res.cloudinary.com/dglknbomx/image/upload/v1728796822/wifv7qeujczfynvjp7v2.png" className="rounded-lg"/>
