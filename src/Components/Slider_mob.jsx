  ...
  return (
    ...
    <div className="App">
      ...
      >
        ...
        <SwiperSlide><img className="px-1 rounded-full" onClick={toggleModal} src={bangle} width={100} height={100}/></SwiperSlide>
        <SwiperSlide><img className="px-1 rounded-full"  onClick={toggleModal} src={bangle} width={100} height={100}/></SwiperSlide>
        <SwiperSlide><img className="px-1 rounded-full"  onClick={toggleModal} src={bangle} width={100} height={100}/></SwiperSlide>
        <SwiperSlide><img className="px-1 rounded-full"  onClick={toggleModal} src={bangle} width={100} height={100}/></SwiperSlide>
        <SwiperSlide><img className="px-1 rounded-full"  onClick={toggleModal} src={bangle} width={100} height={100}/></SwiperSlide>
      ...
      <source src="https://res.cloudinary.com/dglknbomx/video/upload/v1728796770/xowi3rrnntwbg1susb9z.mp4" type="video/mp4" />
